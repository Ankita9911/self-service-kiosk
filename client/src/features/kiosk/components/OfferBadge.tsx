...
> = {
  DISCOUNT: {
    label: (o) =>
      o.discountPercent ? `${o.discountPercent}% OFF` : (o.label ?? "OFFER"),
...
> = {
  ...
  LIMITED: {
    label: () => "⏳ Limited",
    className:
      "bg-orange-50 dark:bg-orange-400/10 text-orange-600 dark:text-orange-400 border border-orange-200 dark:border-orange-400/20",
  },
};
