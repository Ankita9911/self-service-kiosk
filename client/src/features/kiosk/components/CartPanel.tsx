            ...
            {cart.map((item) => {
              ...
              return (
                ...
                >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <button
                          ...
                          className="p-1.5 hover:bg-red-50 rounded-lg transition-all group shrink-0"
                        >
                          <Trash2
                  ...
                  <div className="mt-3 pt-3 border-t border-[#e8f3f0] flex items-center justify-between gap-3">
