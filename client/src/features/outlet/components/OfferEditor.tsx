...
export function OfferEditor({ offers, onChange }: OfferEditorProps) {
  function addOffer(type: OfferType) {
    ...
    onChange([
      ...offers,
      { type, discountPercent: type === "DISCOUNT" ? 10 : undefined },
    ]);
  }
  ...
  function updateDiscount(type: OfferType, val: string) {
    ...
    onChange(
      offers.map((o) =>
        o.type === type ? { ...o, discountPercent: clamped } : o,
      ),
    );
  }
    ...
    <div className="space-y-3">
      ...
      {offers.find((o) => o.type === "DISCOUNT") && (
        <div className="flex items-center gap-2 pl-1">
          ...
          <input
            ...
            step={1}
            value={
              offers.find((o) => o.type === "DISCOUNT")?.discountPercent ?? ""
            }
      ...
      {offers.length > 0 && (
        <p className="text-[10px] text-slate-400 dark:text-slate-500">
          Badges will appear on kiosk item cards. Discounts apply automatically
          in cart.
        </p>
      )}
    </div>
