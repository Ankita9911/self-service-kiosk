    ...
    <div className="space-y-5">
      ...
      {show("ks-pending") && (
        <section>
          ...
          {oldestPendingOrder ? (
            <div className="bg-amber-50 dark:bg-amber-500/[0.08] border border-amber-200 dark:border-amber-500/20 rounded-2xl p-5 flex items-center gap-4">
            ...
            <div className="bg-emerald-50 dark:bg-emerald-500/[0.08] border border-emerald-200 dark:border-emerald-500/20 rounded-2xl p-5 flex items-center gap-4">
