  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3 flex-wrap">
      ...
      {!filters.date && (
        ...
        >
          <SelectTrigger className="h-9 w-38 rounded-xl border-slate-100 dark:border-white/8 bg-white dark:bg-[#161920] text-[13px] text-slate-700 dark:text-slate-200 focus:ring-indigo-400/20">
