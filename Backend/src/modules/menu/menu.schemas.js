...
export const createMenuItemSchema = z.object({
  ...
  inventoryMode:        z.enum(Object.values(INVENTORY_MODE)).optional().default(INVENTORY_MODE.RECIPE),
  serviceType:          z.enum(Object.values(SERVICE_TYPE)).optional().default(SERVICE_TYPE.BOTH),
...
export const updateItemStockSchema = z.object({
  stockQuantity: z.number({ required_error: "stockQuantity is required" }).int().nonnegative("stockQuantity must be non-negative"),
});
