...
import { INGREDIENT_UNIT } from "../ingredients/ingredient.constants.js";
...
export const aiGenerateSchema = z.object({
  description: z.string({ required_error: "description is required" }).min(1, "description cannot be empty").trim(),
});
